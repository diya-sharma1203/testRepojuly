...
var me = User(name: "Gurleen", age: 20, height: 178, weight: 73, activityLevel: 7)
print("Hello, my name is \(me.name) and I am \(me.age) years old.")
print("I am \(me.height) cm tall and weigh \(me.weight) kg.")
print("I am level \(me.activityLevel) active.")
...
var kilometer = Distance(feet: 3808.4)
print(kilometer.meters)
