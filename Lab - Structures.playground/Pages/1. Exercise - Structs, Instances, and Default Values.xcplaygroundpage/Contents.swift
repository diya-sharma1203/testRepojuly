...
let latitude = somePlace.latitude
let longitude = somePlace.longitude
...
favouriteBook.pages = 222
favouriteBook.price = 11.99
print("Title: \(favouriteBook.title)")
print("Author: \(favouriteBook.author)")
print("Pages: \(favouriteBook.pages)")
print("Price: \(favouriteBook.price)")
