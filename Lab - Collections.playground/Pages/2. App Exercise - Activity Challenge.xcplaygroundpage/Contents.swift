 ...
 */
let walkingChallanges : [String ] = ["walk 3 miles a day" , "walk 10 miles a day"]
let runningChallenges : [String ] = ["run 3 miles a day" , "run 10 miles a day"]
...
var challenges = [walkingChallanges , runningChallenges]
let secondChallengeFirstElement = challenges[1][0]
print(secondChallengeFirstElement)
