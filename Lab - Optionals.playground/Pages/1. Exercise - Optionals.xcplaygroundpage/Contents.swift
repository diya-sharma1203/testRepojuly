...
print("userAge value is nil becuase , we have a set of non numeric values, thats why initializer fails to convert it and showing nul")
print(userAge!)
/*:
 ...
 */
print("The word optional comes before the number")
print("After forced unwrapping usinf this ! it results in printing the number")
